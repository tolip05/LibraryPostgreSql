...
public class DbfRow {
    ...
    public DbfRow(DbfHeader header,
     ...
     * @throws DbfException
     *             if there's no field with name fieldName
     */
    ...
    /**
     * Retrieves the value of the designated field as String using given
     * charset.
     *
     * @param fieldName
     *            the name of the field
     * @param charset
     *            the charset to be used to decode field value
     * @return the field value, or null (if the dbf value is NULL)
     * @throws DbfException
     *             if there's no field with name fieldName
     */
    public String getString(String fieldName,
        ...
        return value == null ? null
                : new String(DbfUtils.trimLeftSpaces((byte[]) value),
                charset);
    }
    ...
    private Object get(String fieldName) {
        ...
        if (fieldIndex < 0) {
            throw new DbfException(String.format("Field \"%s\" does not exist",
                    fieldName));
        }
